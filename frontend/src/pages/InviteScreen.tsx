  ...
  if (!task) {
    return (
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-emerald-50 to-blue-50 px-4 py-12">
        <Card className="max-w-lg w-full rounded-2xl shadow-xl border border-amber-200 bg-white/95 backdrop-blur-md">
          <CardContent className="p-12 flex flex-col items-center gap-8">
            <h1 className="text-3xl font-serif font-extrabold text-amber-700 text-center mb-2">Invalid Invite</h1>
      ...
      <Card className="max-w-lg w-full rounded-2xl shadow-xl border border-amber-200 bg-white/95 backdrop-blur-md">
        <CardContent className="p-12 flex flex-col items-center gap-8">
          <div className="flex flex-col items-center gap-3">
            ...
            <h1 className="text-4xl font-serif font-extrabold text-amber-700 text-center mb-1 tracking-tight">
          ...
          <div className="w-full bg-gradient-to-br from-blue-50 to-amber-50 border border-amber-100 rounded-xl shadow p-6 flex flex-col items-center gap-3">
            <Leaf className="h-7 w-7 text-amber-500 mb-1" />
            <div className="text-xl font-bold text-amber-800 text-center">{task}</div>
            <div className="text-sm text-blue-600 text-center italic">
              "Every small step together creates a ripple of change."
            </div>
          </div>
          <div className="w-full bg-white/80 rounded-lg border-l-4 border-amber-400 p-4 mt-2 text-center shadow-sm">
            <span className="text-amber-700 font-semibold">Why you?</span>
          ...
          <Button
            variant="outline"
            className="w-full mt-2 flex items-center gap-2 text-amber-700 border-amber-200"
            onClick={() => navigate(-1)}
          >
            <ArrowLeft className="h-4 w-4" /> Go Back
          </Button>
          <div className="mt-8 text-center text-amber-600 text-xs font-serif italic">
