...
exports.utilityYou = utilityYou;
exports.effortPenalty = effortPenalty;
exports.fitScore = fitScore;
exports.novelty = novelty;
exports.recencyCooldown = recencyCooldown;
exports.diversityMix = diversityMix;
 ...
 */
function utilityYou(metrics, W) {
    const u = W.pkr * nPKR(metrics.pkrMonth) +
 ...
 */
function novelty(recentShown, actionId, N = 30) {
 ...
 */
function recencyCooldown(all, actionId, now = Date.now()) {
 ...
 */
function diversityMix(recentShown, category, K = 20) {
    const r = recentShown.slice(-K);
    const counts = r.reduce((m, c) => {
