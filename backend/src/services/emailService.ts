...
export class EmailService {
   ...
   */
  static async sendCommunityJoinEmail(user: User): Promise<boolean> {
    try {
      const emailData: EmailData = {
        to: user.email,
...
© 2024 Zerrah. All rights reserved.
   ...
   */
  private static generateCommunityJoinEmailHTML(user: User): string {
    return `
      <!DOCTYPE html>
      <html>
      <head>
   ...
   */
  private static generateCommunityJoinEmailText(user: User): string {
    return `
