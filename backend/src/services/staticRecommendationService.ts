interface StaticRecommendationWeek {
  theme: string;
  actions: Array<{
    title: string;
    description: string;
...
interface StaticRecommendationMap {
  [key: string]: {
    week1: StaticRecommendationWeek;
  };
}

const STATIC_RECOMMENDATIONS: StaticRecommendationMap = {
...
export function getStaticRecommendations(userProfile: any) {
